      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-6">
            Ce site fait partie du mouvement <span className="text-primary font-semibold">#StudyBitcoin</span> dans le monde francophone. 
          ...
          <div className="grid sm:grid-cols-3 gap-6 mt-8">
            <div className="flex flex-col items-center gap-2 p-4 rounded-xl glass-card">
