...
const homeJsonLd = {
  ...
  "@graph": [
    ...
    {
      "@type": "ItemList",
      "@id": `${SITE_URL}/#mainresources`,
      name: "Ressources principales pour comprendre Bitcoin",
      ...
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
          url: `${SITE_URL}/fondamentaux`,
          name: "Fondamentaux de Bitcoin",
        },
        {
          "@type": "ListItem",
          position: 2,
          url: `${SITE_URL}/arguments`,
          name: "Arguments contre Bitcoin démontés",
        },
        {
          "@type": "ListItem",
          position: 3,
          url: `${SITE_URL}/securiser`,
          name: "Sécuriser ses bitcoins (hardware wallet)",
        },
        {
          "@type": "ListItem",
          position: 4,
          url: `${SITE_URL}/geek-area`,
          name: "Geek Area : nœud, wallet DIY, livre blanc, dictionnaire",
        },
        {
          "@type": "ListItem",
          position: 5,
          url: `${SITE_URL}/geek-area/dictionnaire`,
          name: "Dictionnaire Bitcoin Pandul",
        },
      ],
    },
  ],
